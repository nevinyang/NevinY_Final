...
var USER_OR_GROUP_NAME = 'nevinyang'; // DONE: Insert GitHub username or group name.
...
////////////////////////////////////////////////////////////////////////////////
app.put('/finals/:id',      // DONE: change to suit your URI design.
  function(req, res) {
    ...
    item.type = 'finals'; // DONE: change to the type of item you want
...
////////////////////////////////////////////////////////////////////////////////
app.get('/finals/',         // DONE: change to suit your URI design. 
  function(req, res) {

    var item_type = 'finals'; // DONE: change to the type of item you want.
    ...
    db.getAll(item_type, function(err, items) {
      ...
      // Otherwise, use the returned data to render an HTML page.
        ...
        res.render(
          'list-finals',   // DONE: change to the name of your HTML template.
          { items: items }
        );
      }
    });
...
////////////////////////////////////////////////////////////////////////////////
app.post('/games/', // DONE: change to suit your URI design.
  function(req, res) {
  
    // Get the item info that was POSTed from the input form.
    // See the form in `views/one-game.ejs`.
    var item = req.body.item;

    item.type = 'game'; // DONE: change to the type of item you want

    // Save the new item to the database. (No ID specified, it will be created.)
    db.save(item.gameid, item, function(err) {
...
////////////////////////////////////////////////////////////////////////////////
app.put('/games/:id', // DONE: change to suit your URI design.
  function(req, res) {
...
////////////////////////////////////////////////////////////////////////////////
app.get('/games/',          // DONE: change to suit your URI design. 
  function(req, res) {

    var item_type = 'game'; // DONE: change to the type of item you want.
    ...
    db.getSome(item_type, req.query, function(err, items) {
      ...
      // Otherwise, use the returned data to render an HTML page.
        ...
        res.render(
          'list-games', // DONE: change to the name of your HTML template.
          { items: items }
        );
      }
    });
...
////////////////////////////////////////////////////////////////////////////////
app.get('/finals/:id',      // DONE: change to suit your URI design.
  function(req, res) {
    ...
    db.getOne(item_type, item_id, function(err, item) {
      ...
      // Otherwise, get the related items associated with this item.
        ...
        var related_type = 'game'; // DONE: change to type of related item.

        // Set our query to find the items related to the requested item.
        req.query.finals = item_id; // DONE: change `party` to reflect the
        ...
        db.getSome(related_type, req.query, function(err, items) {
          ...
          // Otherwise, use the returned data to render an HTML page.
            ...
            res.render(
            'one-finals', // DONE: change to the name of your HTML template.
...
////////////////////////////////////////////////////////////////////////////////
app.get('/games/:id',       // DONE: change to suit your URI design.
  function(req, res) {
    ...
    db.getOne(item_type, item_id, function(err, item) {
      ...
      // Otherwise, get the items potentially related to this item.
        ...
        //Taken from above Finals GET code.  Trying to show all other games
        //within the same Finals series

        // Set our query to find the items related to the requested item.
        req.query.finals = item_id.substr(0, item._id.length-2); 
        ...
        db.getSome(item_type, req.query, function(err, items) {
          ...
          // Otherwise, use the returned data to render an HTML page.
            ...
            res.render(
            'one-game', // DONE: change to the name of your HTML template.
              { item: item, related_items: items }
            );
          }
        });
        /*
        var related_type = 'finals'; // DONE: change to type of related item.
        ...
        db.getAll(related_type, function(err, items) {
          ...
          // Otherwise, use the returned data to render an HTML page.
            ...
            res.render(
              'one-game', // DONE: change to name of your HTML template.
              { item: item, related_items: items }
            );
          }
        });
